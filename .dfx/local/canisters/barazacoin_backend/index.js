...
import { idlFactory } from './barazacoin_backend.did.js';
export { idlFactory } from './barazacoin_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BARAZACOIN_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./barazacoin_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the barazacoin_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./barazacoin_backend.did.js")._SERVICE>}
 */
export const barazacoin_backend = createActor(canisterId);
