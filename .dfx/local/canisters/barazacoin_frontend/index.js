...
import { idlFactory } from './barazacoin_frontend.did.js';
export { idlFactory } from './barazacoin_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BARAZACOIN_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./barazacoin_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the barazacoin_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./barazacoin_frontend.did.js")._SERVICE>}
 */
export const barazacoin_frontend = createActor(canisterId);
